            ...
            <div class="card card-primary" >
              <div class="card-header" >
                <h3 class="card-title"  >TAMBAH DATA MAHASISWA</h3>
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form class="form-horizontal" action='proses_tambah' method='POST'>
                    {{ csrf_field() }}
                    <div class="card-body">
                      <div class="form-group">
                        <label for="exampleInputEmail1">NIM</label>
                        <input type="text" class="form-control" name="nim" id="exampleInputEmail1" placeholder="NIM">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="ipk" id="exampleInputPassword1" placeholder="IPK">
                      </div>
                    </div>
                    <!-- /.card-body -->
